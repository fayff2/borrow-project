  ...
  return (
    <div className="flex">
        ...
        <svg
            ...
            <div className={`h-screen w-64 fixed top-0  ${!isOpen ? "translate-x-0" : "translate-x-full"} transition-transform  text-white bg-sidebar`}>
                        ...
                        <ul className="pt-2 pb-4 space-y-1 flex flex-col  text-lg gap-5">
                            <li className=" border-b-white border-b ">
                                ...
                                >
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" fill="#fff" y="0px" width="25" height="25" viewBox="0 0 32 32">
...
<svg id='Create_Order_24' width='24' height='24' viewBox='0 0 24 24' fill="#fff" xmlns='http://www.w3.org/2000/svg'><rect width='24' height='24' stroke='none' fill='#000000' opacity='0'/>
