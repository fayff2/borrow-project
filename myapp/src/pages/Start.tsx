...
<div className=" flex flex-col gap-10 lg:gap-16 max-w-sm lg:max-w-2xl p-10 bg-white  border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700  text-center items-center h-full">
